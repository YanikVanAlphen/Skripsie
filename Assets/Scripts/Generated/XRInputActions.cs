...
//     version 1.14.0
//     from Assets/Settings/XR Input Actions.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/XR Input Actions.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRI LeftHand X"",
            ""id"": ""d5826028-afb2-40ce-af64-5db3128ffaa5"",
            ""actions"": [
                {
                    ""name"": ""LeftXButton"",
                    ""type"": ""Button"",
                    ""id"": ""84291c4e-860b-4ea6-80c7-e5f4c47b88c6"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""459677c2-14ea-4b8a-b6b7-f64f32a48303"",
    ...
    ""controlSchemes"": [
        ...
        ~@XRInputActions()
        {
            UnityEngine.Debug.Assert(!m_XRIHead.enabled, "This will cause a leak and performance issues, XRInputActions.XRIHead.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_XRILeftHand.enabled, "This will cause a leak and performance issues, XRInputActions.XRILeftHand.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_XRILeftHandInteraction.enabled, "This will cause a leak and performance issues, XRInputActions.XRILeftHandInteraction.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_XRILeftHandLocomotion.enabled, "This will cause a leak and performance issues, XRInputActions.XRILeftHandLocomotion.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_XRIRightHand.enabled, "This will cause a leak and performance issues, XRInputActions.XRIRightHand.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_XRIRightHandInteraction.enabled, "This will cause a leak and performance issues, XRInputActions.XRIRightHandInteraction.Disable() has not been called.");
        ...
        // XRI LeftHand X
        private readonly InputActionMap m_XRILeftHandX;
        private List<IXRILeftHandXActions> m_XRILeftHandXActionsCallbackInterfaces = new List<IXRILeftHandXActions>();
        private readonly InputAction m_XRILeftHandX_LeftXButton;
        /// <summary>
        /// Provides access to input actions defined in input action map "XRI LeftHand X".
        /// </summary>
        public struct XRILeftHandXActions
        {
            private @XRInputActions m_Wrapper;
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public XRILeftHandXActions(@XRInputActions wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "XRILeftHandX/LeftXButton".
            /// </summary>
            public InputAction @LeftXButton => m_Wrapper.m_XRILeftHandX_LeftXButton;
            /// <summary>
            /// Provides access to the underlying input action map instance.
            /// </summary>
            public InputActionMap Get() { return m_Wrapper.m_XRILeftHandX; }
            /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
            public void Enable() { Get().Enable(); }
            /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
            public void Disable() { Get().Disable(); }
            ...
            public bool enabled => Get().enabled;
            /// <summary>
            /// Implicitly converts an <see ref="XRILeftHandXActions" /> to an <see ref="InputActionMap" /> instance.
            /// </summary>
            public static implicit operator InputActionMap(XRILeftHandXActions set) { return set.Get(); }
            /// <summary>
            /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
            /// </summary>
            /// <param name="instance">Callback instance.</param>
            ...
            /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
            /// </remarks>
            /// <seealso cref="XRILeftHandXActions" />
            public void AddCallbacks(IXRILeftHandXActions instance)
            {
                if (instance == null || m_Wrapper.m_XRILeftHandXActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_XRILeftHandXActionsCallbackInterfaces.Add(instance);
                @LeftXButton.started += instance.OnLeftXButton;
                @LeftXButton.performed += instance.OnLeftXButton;
                @LeftXButton.canceled += instance.OnLeftXButton;
            }
            ...
            /// </remarks>
            /// <seealso cref="XRILeftHandXActions" />
            private void UnregisterCallbacks(IXRILeftHandXActions instance)
            {
                @LeftXButton.started -= instance.OnLeftXButton;
                @LeftXButton.performed -= instance.OnLeftXButton;
                @LeftXButton.canceled -= instance.OnLeftXButton;
            ...
            /// <summary>
            /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="XRILeftHandXActions.UnregisterCallbacks(IXRILeftHandXActions)" />.
            /// </summary>
            /// <seealso cref="XRILeftHandXActions.UnregisterCallbacks(IXRILeftHandXActions)" />
            public void RemoveCallbacks(IXRILeftHandXActions instance)
            {
                if (m_Wrapper.m_XRILeftHandXActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }
            ...
            /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
            /// </remarks>
            /// <seealso cref="XRILeftHandXActions.AddCallbacks(IXRILeftHandXActions)" />
            /// <seealso cref="XRILeftHandXActions.RemoveCallbacks(IXRILeftHandXActions)" />
            /// <seealso cref="XRILeftHandXActions.UnregisterCallbacks(IXRILeftHandXActions)" />
            public void SetCallbacks(IXRILeftHandXActions instance)
            {
                foreach (var item in m_Wrapper.m_XRILeftHandXActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_XRILeftHandXActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        /// <summary>
        ...
        /// <summary>
        /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "XRI LeftHand X" which allows adding and removing callbacks.
        /// </summary>
        /// <seealso cref="XRILeftHandXActions.AddCallbacks(IXRILeftHandXActions)" />
        /// <seealso cref="XRILeftHandXActions.RemoveCallbacks(IXRILeftHandXActions)" />
        public interface IXRILeftHandXActions
        {
            /// <summary>
            /// Method invoked when associated input action "LeftXButton" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
            /// </summary>
            /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
